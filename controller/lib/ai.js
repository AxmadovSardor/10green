...
async function getAIResponse(userText) {
  try {
    const prompt = `If this context contains the answer, use it. Otherwise, answer from your general knowledge. Time now is ${now} in UTC and most of users in UTC+5 reagon so just say that time with UTC+5 time zone if you are asked about current time.
